...
tickerDfF = tickerDataFB.history(period='1d', start='2010-12-25', end='2021-12-25')
# Open High  Low Close  Volume Dividends  Stock Splits
tickerDfA = tickerDataAMZN.history(period='1d', start='2010-12-25', end='2021-12-25')
# Open High  Low Close  Volume Dividends  Stock Splits
tickerDfA2 = tickerDataAAPL.history(period='1d', start='2010-12-25', end='2021-12-25')
# Open High  Low Close  Volume Dividends  Stock Splits
tickerDfN = tickerDataNFLX.history(period='1d', start='2010-12-25', end='2021-12-25')
# Open High  Low Close  Volume Dividends  Stock Splits
tickerDfG = tickerDataGOOG.history(period='1d', start='2010-12-25', end='2021-12-25')
# Open High  Low Close  Volume Dividends  Stock Splits
tickerDfT = tickerDataTSLA.history(period='1d', start='2010-12-25', end='2021-12-25')
# Open High  Low Close  Volume Dividends  Stock Splits


st.write("# :rocket: The ***FAANG*** Stock Spotlight :rocket: ")
st.write("### *From Christmas 2010-2021*")
st.write("# ***F***:")
